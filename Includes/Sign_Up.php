...
if(isset($_POST['sign_Up'])){
    ...
    || empty($Email) || empty($password) || empty($re_password) ){
    ...
    elseif($password != $re_password ){
        ...
        $sql = "INSERT INTO users(username , fullname ,	email, phonenumber, proilePicture, pwd	)
        VALUES(? , ? , ? , ? , ? , ?);";
        ...
        if(!mysqli_stmt_prepare($stmt , $sql)){
            ...
            mysqli_stmt_bind_param($stmt , "ssssss" , $Username , $name , $Email , $number ,$destination , $hased_Pwd );

            mysqli_stmt_execute($stmt);


            $msg = "File Uploaded, Sign up successful, Welcome";
